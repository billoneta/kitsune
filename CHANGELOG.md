...
### [Version&nbsp;`1.1.34`](https://github.com/billoneta/kitsune/compare/v1.1.33...v1.1.34)
🗓️ **Released:** `2025-06-06`

#### 🔧 Chores

- **🎯 Config**: More robust modification for renovate.
...
* **🎯 Config**: More robust modification for renovate ([8dd7314](https://github.com/billoneta/kitsune/commit/8dd7314)) - by: [<img width="16" height="16" src="https://avatars.githubusercontent.com/u/103044629?v=4" /> **k4itrun**](https://github.com/k4itrun)
...
### [Version&nbsp;`1.1.33`](https://github.com/billoneta/kitsune/compare/v1.1.32...v1.1.33)
🗓️ **Released:** `2025-05-22`

#### 📝 Documentation

update headers in README.md files.
...
* Update headers in README.md files ([d2b5319](https://github.com/billoneta/kitsune/commit/d2b5319)) - by: [<img width="16" height="16" src="https://avatars.githubusercontent.com/u/103044629?v=4" /> **k4itrun**](https://github.com/k4itrun)
...
improve bug report templates and feature requests.
...
* Improve bug report templates and feature requests ([4895a14](https://github.com/billoneta/kitsune/commit/4895a14)) - by: [<img width="16" height="16" src="https://avatars.githubusercontent.com/u/103044629?v=4" /> **k4itrun**](https://github.com/k4itrun)
...
### [Version&nbsp;`1.1.29`](https://github.com/billoneta/kitsune/compare/v1.1.28...v1.1.29)
🗓️ **Released:** `2025-05-17`

#### 🔧 Chores

Move Renew settings to a new file and delete the old one.
...
* Move Renew settings to a new file and delete the old one ([0f4ec2c](https://github.com/billoneta/kitsune/commit/0f4ec2c)) - by: [<img width="16" height="16" src="https://avatars.githubusercontent.com/u/103044629?v=4" /> **k4itrun**](https://github.com/k4itrun)
...
Update README.md files for @billoneta/gitmoji and @billoneta/utils with project details and installation instructions.
...
* Update README.md files for @billoneta/gitmoji and @billoneta/utils with project details and installation instructions ([1eb5e7f](https://github.com/billoneta/kitsune/commit/1eb5e7f)) - by: [<img width="16" height="16" src="https://avatars.githubusercontent.com/u/103044629?v=4" /> **k4itrun**](https://github.com/k4itrun)
...
### [Version&nbsp;`1.1.25`](https://github.com/billoneta/kitsune/compare/v1.1.24...v1.1.25)
🗓️ **Released:** `2025-05-17`
...
* Standardize import statements to use single quotes ([c283345](https://github.com/billoneta/kitsune/commit/c283345)) - by: [<img width="16" height="16" src="https://avatars.githubusercontent.com/u/103044629?v=4" /> **k4itrun**](https://github.com/k4itrun)
...
fix extends syntax in renovate configuration.
...
* Fix extends syntax in renovate configuration ([f84b6b4](https://github.com/billoneta/kitsune/commit/f84b6b4))
...
Update package versions to 1.0.4 for config, gitmoji, and utils packages.
...
* Update package versions to 1.0.4 for config, gitmoji, and utils packages ([309dcee](https://github.com/billoneta/kitsune/commit/309dcee))
...
Update Pull Request section for clarity and consistency in instructions.
...
* Update Pull Request section for clarity and consistency in instructions ([c1a9755](https://github.com/billoneta/kitsune/commit/c1a9755))
